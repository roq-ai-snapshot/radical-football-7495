...
-- AddForeignKey
ALTER TABLE "player_profile" ADD CONSTRAINT "player_profile_coach_id_fkey" FOREIGN KEY ("coach_id") REFERENCES "coach"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
